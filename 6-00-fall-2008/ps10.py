...
class Hand(object):
    ...
    def containsLetters(self, letters):
        ...
        """
       # print letters
        for letter, freq in getFrequencyDict(letters).iteritems():
    ...
    def isEmpty(self):
        ...
        """
        for k, v in self.handDict.iteritems():
            if v > 0:
                return False
        return True
    ...
    def __eq__(self, other):
        ...
        """
        return type(self) == type(other) and self.handDict == other.handDict
    def __str__(self):
        """
...
class ComputerPlayer(Player):
    ...
    def pickBestWord(self, wordlist):
        ...
        for word in wordlist.getList():
            if self.getHand().containsLetters(word) and getWordScore(word) > bestWordScore:
                bestWordScore = getWordScore(word)
                bestWord = word
        return bestWord
