...
def pipeline(domain,pages,max_out_bound=4,debuglevel=0):
    ...
    data = [None]*pagecount
    headers = {'Host':'93.2.85.1:9002','Connection':'Keep-Alive','Accept-Encoding':'gzip,deflate',}
...
if __name__ == '__main__':
    domain = '93.2.85.1:9002'
    pages = ('/cjp001.html','/cjp002.html','/cjp003.html')
    data = pipeline(domain,pages,max_out_bound=1,debuglevel=1)
